...
dash.register_page(__name__, path="/poland_cancer_1999-2013_males_incidence50_85", suppress_callback_exceptions=True)
# ---------------------------------------------------------------
...
df = pd.read_excel(
    r"C:\Users\kruge\PycharmProjects\cancer\pages\dataset\Incidence_by_cancer_males_Poland\Incidence_by_cancer_males_Poland_50-85_Years_1999_2013.xlsx")
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='barchart_15'),
        ], className='six columns'),

        html.Div([
            dcc.Graph(id='piechart_15'),
        ], className='six columns'),
...
# ------------------------------------------------------------------
@callback(
    [Output('piechart_15', 'figure'),
     Output('barchart_15', 'figure')],
...
def update_data(chosen_rows, piedropval, bardropval):
    ...
    bar_chart = px.bar(
        ...
        title='Incidence by cancer - Poland - 1999-2013 - 50-49 years - Males',  # figure title
        width=2500,  # figure width in pixels
        height=720,  # figure height in pixels
