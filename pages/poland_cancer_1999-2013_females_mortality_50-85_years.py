...
dash.register_page(__name__, path="/poland_cancer_1999-2013_females_mortality50_85", suppress_callback_exceptions=True)
# ---------------------------------------------------------------
...
df = pd.read_excel(r"C:\Users\kruge\PycharmProjects\cancer\pages\dataset\Mortality_by_cancer_summary_Poland\Mortality_by_cancer_summary_Poland_50-85_Years_1999_2013.xlsx")
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='barchart_10'),
        ], className='six columns'),

        html.Div([
            dcc.Graph(id='piechart_10'),
        ], className='six columns'),
...
# ------------------------------------------------------------------
@callback(
    [Output('piechart_10', 'figure'),
     Output('barchart_10', 'figure')],
...
def update_data(chosen_rows, piedropval, bardropval):
    ...
    bar_chart = px.bar(
        ...
        title='Mortality by cancer - Poland - 1999-2013 - 50-85 years - Females',  # figure title
        width=2500,  # figure width in pixels
        height=720,  # figure height in pixels
