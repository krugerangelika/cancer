...
df = pd.read_excel(
    r"C:\Users\kruge\PycharmProjects\cancer\pages\dataset\Estimated_incidence_by_cancer_summary_europe\Estimated_incidence_by_cancer_summary_females_europe_2.xlsx")
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='barchart_1'),
        ], className='six columns'),

        html.Div([
            dcc.Graph(id='piechart_1'),
        ], className='six columns'),
