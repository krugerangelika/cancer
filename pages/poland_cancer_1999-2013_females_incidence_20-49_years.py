...
dash.register_page(__name__, path="/poland_cancer_1999-2013_females_incidence20_49", suppress_callback_exceptions=True)
# ---------------------------------------------------------------
...
df = pd.read_excel(r"C:\Users\kruge\PycharmProjects\cancer\pages\dataset\Incidence_by_cancer_summary_Poland\Incidence_by_cancer_summary_Poland_20-49_Years_1999_2013.xlsx")
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='barchart_7'),
        ], className='six columns'),

        html.Div([
            dcc.Graph(id='piechart_7'),
        ], className='six columns'),
...
# ------------------------------------------------------------------
@callback(
    [Output('piechart_7', 'figure'),
     Output('barchart_7', 'figure')],
