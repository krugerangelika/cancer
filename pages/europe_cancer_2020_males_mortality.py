...
dash.register_page(__name__, suppress_callback_exceptions=True,  path="/europe_cancer_2020_males_mortality")
...
df = pd.read_excel(
    r"C:\Users\kruge\PycharmProjects\cancer\pages\dataset\Estimated_mortality_by_cancer_summary_europe\Estimated_mortality_by_cancer_summary_males_europe.xlsx")
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='barchart_21'),
        ], className='six columns'),

        html.Div([
            dcc.Graph(id='piechart_21'),
        ], className='six columns'),
...
# ------------------------------------------------------------------
@callback(
    [Output('piechart_21', 'figure'),
     Output('barchart_21', 'figure')],
