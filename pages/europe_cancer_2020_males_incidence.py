...
dash.register_page(__name__, suppress_callback_exceptions=True,  path="/europe_cancer_2020_males_incidence")

# ---------------------------------------------------------------
# źródło https://ecis.jrc.ec.europa.eu/explorer.php?$0-0$1-AEE$2-All$4-1$3-All$6-0,85$5-2020,2020$7-7$CEstByCancer$X0_8-3$CEstRelativeCanc$X1_8-3$X1_9-AE27$CEstBySexByCancer$X2_8-3$X2_-1-1
df = pd.read_excel(
    r"C:\Users\kruge\PycharmProjects\cancer\pages\dataset\Estimated_incidence_by_cancer_summary_europe\Estimated_incidence_by_cancer_summary_males_europe.xlsx")
...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            dcc.Graph(id='barchart_20'),
        ], className='six columns'),

        html.Div([
            dcc.Graph(id='piechart_20'),
        ], className='six columns'),
...
# ------------------------------------------------------------------
@callback(
    [Output('piechart_20', 'figure'),
     Output('barchart_20', 'figure')],
